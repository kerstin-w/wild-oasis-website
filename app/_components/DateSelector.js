...
/**
 * Checks if a given range is already booked in an array of dates.
 *
 * @param {Object} range - The range to check.
 * @param {Object[]} datesArr - The array of dates to check against.
 * @returns {boolean} - Returns true if the range is already booked, false otherwise.
 */
