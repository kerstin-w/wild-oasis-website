...
/* The line `export const revalidate = 86400;` is setting the revalidation time for the page to 86400 econds (which is equivalent to 24 hours). This value indicates to Next.js how often the page should be revalidated to check for updates. In this case, the page will be revalidated every 24 hours to
ensure that the content is up to date. */
